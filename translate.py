"""
Multi-camera grid viewer - PyQt5 version
"""
...
from PyQt5 import QtCore, QtGui, QtWidgets  # GUI framework - makes windows, buttons
from PyQt5.QtCore import Qt, QThread, QTimer, pyqtSignal, pyqtSlot  # Core Qt features
    ...
    def run(self):
        ...
        while self._running:
            try:
                ...
                time.sleep(
                    0.01
                )  # Don't overload CPU because my main targets were Raspberry Pis
...
def main():
    ...
    if working_cameras:
        ...
        for cam_index in working_cameras[:9]:
            cw = CameraWidget(
                widget_width, widget_height, cam_index, parent=central_widget
            )
